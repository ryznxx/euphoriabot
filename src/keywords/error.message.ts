...
const error: ErrorMess = {
  ...
  commandNotExecuted: "Operasi perintah tidak dijalankan karena mengandung kata terlarang.",
  ...
  badwordAddSuccess: "kata tersebut sudah ditambahkan kedalam database badword",
